...
DataBean dataBean = new DataBean();
 ...
 try {
	           ...
	           String condition="select * from personalmessage where give = '"+request.getParameter("logname")+"'";
	           sql=con.createStatement();  
            	  ...
            	  out.print("<th >"+"用户"+"</th>");
            	  out.print("<th >"+"内容"+"</th>");
            	  out.print("<th >"+"时间"+"</th></tr>");
            	
	              while(rs.next()) {
	            	  out.print("<tr>");
	            	  out.print("<td >"+rs.getString(1)+"</td>");
	            	  
	            	  out.print("<td ><textarea >"+rs.getString(2)+"</textarea></td>");
	            	  out.print("<td >"+rs.getString(3)+"</tr>");
